...
namespace Orleans.Streams
{
    ...
    {
        public byte[] SequenceToken { get; protected set;  }

        public bool Equals(StreamSequenceToken other) => new ReadOnlySpan<byte>(this.SequenceToken).SequenceEqual(other.SequenceToken);

        public int CompareTo(StreamSequenceToken other) => new ReadOnlySpan<byte>(this.SequenceToken).SequenceCompareTo(other.SequenceToken);
    }
