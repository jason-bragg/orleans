...
namespace Orleans.Streams
{
    ...
    internal interface IStreamPubSub // Compare with: IPubSubRendezvousGrain
    {
        ...
        Task RegisterConsumer(GuidId subscriptionId, StreamId streamId, string streamProvider, IStreamConsumerExtension streamConsumer);
        ...
        Task<IList<StreamSubscription<Guid>>> GetAllSubscriptions(StreamId streamId, IStreamConsumerExtension streamConsumer = null);
