...
{
    internal class IncomingMessageSocketAcceptor : AsynchAgent
    {
        ...
        internal IncomingMessageSocketAcceptor(MessageCenter msgCtr, IPEndPoint here, SocketDirection socketDirection)
        {
        ...
        {
            var ima = result.AsyncState as IncomingMessageSocketAcceptor;
            try
            {
                if (ima == null)
                {
        ...
        private class ReceiveCallbackContext
        {
            ...
            public IncomingMessageSocketAcceptor IMA { get; private set; }

            public ReceiveCallbackContext(Socket sock, IncomingMessageSocketAcceptor ima)
            {
                Sock = sock;
