...
namespace Orleans.Transactions
{
    ...
    /// </summary>
    public class LockOnlyTransactionalState<TState> : ITransactionalState<TState>, ILifecycleParticipant<IGrainLifecycle>
        where TState : class, new()
    {
        ...
        private LockOnlyTransactionQueue<TState> queue;
        ...
        public LockOnlyTransactionalState(
        ...
        private static void SetupResourceFactory(IGrainActivationContext context, string stateName, ITransactionQueue<TState> queue)
        {
        ...
        internal async Task OnSetupState(CancellationToken ct, Action<IGrainActivationContext, string, ITransactionQueue<TState>> setupResourceFactory)
        {
            ...
            this.queue = new LockOnlyTransactionQueue<TState>(options, this.participantId, clock, logger);
