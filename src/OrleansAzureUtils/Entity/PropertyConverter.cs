...
namespace Orleans.Azure
{
    ...
    public class PropertyConverter
    {
        ...
        public PropertyConverter(IPropertyConverter converter)
        {
            ...
            try
            {
                switch (storageProperty.PropertyType)
                {
                    case EdmType.String:
                        ...
                        {
                            this.converter.ConvertFromStorage(obj, userProperty, storageProperty);
                        }
                        return;
                    case EdmType.Binary:
        ...
        public void ConvertToStorage(object obj, PropertyInfo userProperty, out EntityProperty storageProperty)
        {
            try
            {
                ...
                {
                    this.converter.ConvertToStorage(obj, userProperty, out storageProperty);
                }
            }
            catch (Exception ex)
            {
