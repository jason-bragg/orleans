...
namespace Orleans.ServiceBus.Providers
{
    ...
    public class EventHubQueueCacheFactory : IEventHubQueueCacheFactory
    {
            ...
            SerializationManager serializationManager, EventHubMonitorAggregationDimensions sharedDimensions, ITelemetryProducer telemetryProducer)
        {
            ...
            return new EventHubQueueCache(EventHubAdapterReceiver.MaxMessagesPerRead, bufferPool, dataAdatper, evictionStrategy, checkpointer, loggerFactory.CreateLogger($"{typeof(EventHubQueueCache).FullName}.{sharedDimensions.EventHubPath}.{partition}"),  
