        ...
        private class TestCacheDataAdapter : ICacheDataAdapter
        {
            ...
            public IBatchContainer GetBatchContainer(ref CachedMessage cachedMessage)
            {
                ...
                return new TestBatchContainer
                {
                    ...
                    StreamNamespace = decodedStreamNamespace,
        ...
        private class CachedMessageConverter
        {
            ...
            public CachedMessage ToCachedMessage(TestQueueMessage queueMessage, DateTime dequeueTimeUtc)
            {
                ...
                return new CachedMessage
                {
                    ...
                    Segment = SerializeMessageIntoPooledSegment(streamPosition, queueMessage),
            ...
            private ArraySegment<byte> SerializeMessageIntoPooledSegment(StreamPosition streamPosition, TestQueueMessage queueMessage)
            {
                // serialize payload
                int size = SegmentBuilder.CalculateAppendSize(queueMessage.StreamNamespace) +
                    SegmentBuilder.CalculateAppendSize(queueMessage.Data);
                ...
                int writeOffset = 0;
                SegmentBuilder.Append(segment, ref writeOffset, queueMessage.StreamNamespace);
